...
import { X, Copy, Check, Link, Trash2, Smartphone, ShieldCheck, Activity, QrCode, Camera, CheckCircle } from 'lucide-react';
        ...
        <div className="modal-overlay" onClick={onClose} style={{ zIndex: 9999 }}>
            {syncSuccess ? (
                <div className="modal-content" onClick={e => e.stopPropagation()} style={{ maxWidth: '400px', textAlign: 'center', padding: '32px' }}>
                    ...
                    <button className="primary-btn" onClick={onClose} style={{ padding: '10px 32px', display: 'inline-flex' }}>
                        Okay
                    </button>
                </div>
            ) : (
